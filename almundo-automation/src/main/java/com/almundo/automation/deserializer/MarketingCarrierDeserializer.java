...
public class MarketingCarrierDeserializer implements JsonDeserializer<MarketingCarrier> {

	@Override
	public MarketingCarrier deserialize(JsonElement json, Type typeOfT,
			JsonDeserializationContext context) throws JsonParseException {
		final JsonObject jsonObject = json.getAsJsonObject();
		final JsonObject jsonCarrierObject = jsonObject.getAsJsonObject("marketing_carrier");
